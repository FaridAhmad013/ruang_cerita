...
use App\Models\MKelengkapanDokumenSmki;
use Carbon\Carbon;
...
class MKelengkapanDokumenDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->editColumn('is_mandatory', function($item){
                return $item->is_mandatory === true ? 'Ya' : 'Tidak';
            })
     ...
     */
    public function query(MKelengkapanDokumenSmki $model): QueryBuilder
    {
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('is_mandatory')->title('Dokumen wajib diisi?'),
